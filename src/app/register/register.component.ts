...
export class RegisterComponent implements OnInit {
  ...
  loginForm = new FormGroup({
    ...
    University_Board2: new FormControl(''),
    Specialization2: new FormControl(''),
    YR2: new FormControl(""),
    Grade_CGPA2: new FormControl(''),
    Qualification3: new FormControl(''),
    University_Board3: new FormControl(''),
    Specialization3: new FormControl(''),
    YR3: new FormControl(""),
    Grade_CGPA3: new FormControl(''),
    Qualification4: new FormControl(''),
    University_Board4: new FormControl(''),
    Specialization4: new FormControl(''),
    YR4: new FormControl(""),
    Grade_CGPA4: new FormControl(''),
    Name6: new FormControl(''),
    Institute: new FormControl(''),
    MY: new FormControl(''),
    UploadImage:new FormControl(''),
    Name10: new FormControl(''),
    Institute10: new FormControl(''),
    MY10: new FormControl(''),
    UploadImage10:new FormControl(''),
    Name11: new FormControl(''),
    Institute11: new FormControl(''),
    MY11: new FormControl(''),
    UploadImage11:new FormControl(''),
    ...
    UploadImageClass10:new FormControl(''),
    CLASS12: new FormControl(''),
    UploadImageClass12:new FormControl(''),
    DEGREE1: new FormControl(''),
    UploadImageDegree1:new FormControl(''),
    ACADEMIC: new FormControl(''),
    UploadImageACADEMIC:new FormControl(),
    PAN: new FormControl(''),
    UploadImagePAN:new FormControl(''),
    PAYSLIP: new FormControl(''),
    UploadImagePAYSLIP:new FormControl(''),
    RELIEVINGLETTER: new FormControl(''),
    UploadImageRELIEVINGLETTER:new FormControl(''),
    Experienceletter: new FormControl(''),
    UploadImageExperienceletter:new FormControl(''),
    appointmentletter: new FormControl(''),
    UploadImageappointmentletter:new FormControl(''),
    PHOTO: new FormControl(''),
    UploadImagePHOTO:new FormControl(''),
